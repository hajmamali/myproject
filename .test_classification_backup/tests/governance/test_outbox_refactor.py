...
@pytest.fixture
def mock_neo4j_conn():
    with patch("mahoun.infrastructure.workers.outbox_worker.get_connection") as mock:
        yield mock

@pytest.fixture
def mock_pg_conn():
    with patch("mahoun.infrastructure.workers.outbox_worker.psycopg2.connect") as mock:
        conn = MagicMock()
...
@pytest.fixture
def mock_gov_ctx():
    with patch("mahoun.infrastructure.workers.outbox_worker.GovernanceContextManager") as mock:
        ctx_cm = MagicMock()
