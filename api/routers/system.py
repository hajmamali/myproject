...
async def get_system_health() -> Dict[str, Any]:
    ...
    # ========================================================================
    # Neo4j Health Check - GOVERNANCE COMPLIANT
    # ========================================================================
    ...
    if settings.graph_enabled and settings.graph_backend != "disabled_fallback":
        try:
            ...
            # GOVERNANCE FIX: Use governed connection instead of direct driver access
            from mahoun.graph.neo4j.connection import get_connection
            
            connection = get_connection()
            # ACTUAL QUERY through governance boundary - NOT FAKE!
            ...
            neo4j_status = "unhealthy"
            neo4j_error = "Governed Neo4j connection not available"
            neo4j_latency = (time.time() - neo4j_start) * 1000
        except Exception as e:
            neo4j_status = "unhealthy"
            neo4j_error = str(e)
